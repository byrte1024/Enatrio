...
static void EditorOverlay_SetUpdateTime(double us) {
    _editor_ring_push(&_editor_state.update, (float)us);
}

static void EditorOverlay_SetRenderTime(double us) {
    _editor_ring_push(&_editor_state.render, (float)us);
}

static int EditorOverlay_IsPaused(void) {
    return _editor_state.paused;
}

static int EditorOverlay_DumpRequested(void) {
...
static void EditorOverlay_Draw(void) {
