...
static int EditorInspector_GraphRequested(TempObjectReference *out_target) {
...
static void EditorInspector_Update(void) {
...
static void EditorInspector_Draw(TempObjectReference selected) {
    if (!_insp_state.visible) return;
